...
A pixel-perfect **frontend clone of the Olive App landing page**, built using modern React tools.
This project focuses on UI/UX accuracy, smooth animations, and responsive design.
